  ...
  for (int i = 0; i < 8; i++) {
    for (int j = 0; j < 8; j++) {
      ...
      if (piece == 'k' || piece == 'K') {
        ...
        if (piece == 'n') {
            xw->fillRectangle(j * 50 + 12, i * 50 + 12, 25, 25, Xwindow::Red);
        } else {
            xw->fillRectangle(j * 50 + 12, i * 50 + 12, 25, 25, Xwindow::Blue);
        }
        ...
        if (piece == 'q') {
            xw->fillRectangle(j * 50 + 5, i * 50 + 5, 40, 40, Xwindow::Red);
        } else {
            xw->fillRectangle(j * 50 + 5, i * 50 + 5, 40, 40, Xwindow::Blue);
        }
      }
    }
  }
